...
import { Search, MapPin, Home, SlidersHorizontal, ArrowUpDown, Check, ChevronsUpDown } from "lucide-react";
...
export function PropertySearchBar() {
    ...
    return (
        <div className="w-full rounded-2xl border border-border/60 bg-card p-3 shadow-lg backdrop-blur-md">
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-12 md:items-center">
                ...
                <div className="md:col-span-2">
                    <Popover>
                        ...
                        <PopoverContent className="w-80 space-y-5 p-5" align="end">
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger
                                    className={cn(
                                        buttonVariants({ variant: "outline" }),
                                        "h-11 w-full justify-between border-border bg-background text-xs font-medium text-foreground hover:bg-accent"
                                    )}
                                >
                                    <div className="flex items-center gap-2 truncate">
                                        ...
                                        {SORT_OPTIONS.map((option) => {
                                            ...
                                            return (
                                                <DropdownMenuItem
                                                    ...
                                                    className={cn(
                                                        "cursor-pointer text-xs font-medium focus:bg-accent focus:text-accent-foreground",
